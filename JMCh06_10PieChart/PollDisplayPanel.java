...
public class PollDisplayPanel extends JPanel
{
    ...
    {
        String str;
        str = name1 + ": " + count1 + "  " + name2 + ": " + count2 + "  " + name3 + ": " + count3;
        return str;
    }
    ...
    private void drawPieChart( Graphics g, int x, int y, int r )
    {
        ...
        if ( total > 0 )
        {
            ...
            drawSector( g, x, y, r, fromDegree + degrees1, degrees2 );

            g.setColor( Color.BLUE );
            drawSector( g, x, y, r, fromDegree + degrees1 + degrees2, 360 - (degrees1 + degrees2));
        }
        else
        {
    ...
    {
        float xtraVar;
        xtraVar = 360 * ((float)count / (float)total);
        int a = Math.round(xtraVar);
        return a;
    }
