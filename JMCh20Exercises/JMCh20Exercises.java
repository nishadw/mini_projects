 ...
 *
 * @author my monicer is Nishad
 * @version 1/10/22
 * @author Period: right now
...
public class JMCh20Exercises<E>
{
    ...
    public ListNode<E> removeFirst(ListNode<E> head)
    {
        ...
        ListNode<E> newFirst = head.getNext();
        head.setNext(null);
        head = newFirst;
        return head;
    ...
    {
        ListNode<E> mode = head;
        int counter = 0;
        for (counter = 0; mode != null; counter++)
        {
            mode = mode.getNext();
        }
    ...
    public ListNode<String> concatenateStrings(ListNode<String> head)
    {
        ...
        ListNode<String> mode = head.getNext();
        String str = head.getValue();
        ListNode<String> lead = new ListNode<String>(str, null);
        ListNode<String> newNode = lead;
        head = head.getNext();
        ...
        while (mode != null)
        {
            ...
            lead.setNext(new ListNode<String>(str, null));
    ...
    public ListNode<E> rotate(ListNode<E> head)
    {
        ...
        ListNode<E> bed = add(removeFirst2(head), head.getValue());
     ...
     * @return head of the new list
     */
    public ListNode<E> removeFirst2(ListNode<E> head)
    {
        if (head == null)
            throw new NoSuchElementException();
    ...
    public ListNode<String> insertInOrder(ListNode<String> head, String s)
    {
        ...
        ListNode<String> lead = head;
        ListNode<String> header = lead;
        ListNode<String> said = head;

        while (said != null) {
            if (said.getValue().compareTo(s) == 0)
            {
                return head;
            }
            said = said.getNext();
        ...
        {
            ListNode<String> newFirst = new ListNode<String>(s, head);
        ...
        {
            head = head.getNext();
            while (head != null && head.getValue().compareTo(s) < 0)
            {
                if (head.getValue().compareTo(s) == 0) {
                    return head;
                }
            ...
            lead.setNext(new ListNode<String>(s, lead.getNext()));
            return header;
    ...
    {
        ListNode<String> header = head;

        while (header != null)
        {
            ListNode<String> value1 = header;
            ListNode<String> value2 = header.getNext();
            ...
            header.setValue(value1.getValue());
            value1.setValue(str);
    ...
    {
        ListNode2<Integer> value1 = head;
        Integer max = value1.getValue();
        
        int total = 0;

        while (value1 != null) {
            if (max < value1.getValue()) {
                max = value1.getValue();
        
            }
            value1 = value1.getNext();
            total++;
        }

        int i = 1;
        value1 = head;
        ListNode2<Integer> value2 = head;
        ...
        ListNode2<Integer> value3 = value1;

        while (value1 != null) {
            if (max == value1.getValue()) {
                if (value1.getValue() == head.getValue()) {
                    return head.getNext();
                }

                else if (max == value2.getPrevious().getValue()) {
                    value2.getPrevious().getPrevious().setNext(null);
                    return value3;
                }
                else {
                    value1.getPrevious().setNext(value1.getNext());
                    value1.getNext().setPrevious(value1.getPrevious());
                    return value3;
                }   
            }
            value1 = value1.getNext();
