...
public class JMCh12Exercises
{
    ...
    public char getRandomRps()
    {
        ...
        char c = array[rand.nextInt(array.length)];
    ...
    public String whatDoesMysteryCountCount()
    {
        ...
        String answer = mCount + " is the count of zeroes in int array v before a number greater than 0"; 
    ...
    public static int[] makePythagoreanTriple( int m, int n )
    {
        ...
        int[] array = {(m * m) - (n * n), 2 * m * n, (m * m) + (n * n)};
    ...
    public static int computeScore( String word )
    {
        ...
        for (int i = 0; i < word.length(); i++) {
            str = "" + word.charAt(i);
            indexer = alphabet.indexOf(str);
            total += letterScores[indexer];
        }
    ...
    public void removeMin( ArrayList<Integer> list )
    {
        ...
        Integer indexer = list.indexOf(smallest);
        list.remove(indexer);
    ...
    public static double averageTopTwo( int[] scores )
    {
        ...
        double avg = (scores[iMax1] + scores[iMax2]) * 0.5;
        return avg;
    }
    ...
    public static boolean covers( double[][] m1, double[][] m2 )
    {
        ...
        return (count * 2 >= (m1.length * m1[0].length));
    }
